...
void CircularObstacle::PlotObstacle(std::vector<int8_t> &map, MapMetaInfo map_meta) {
    ...
    PlotPointProbability(map, center_x_, center_y_, map_meta);
    PlotPointProbability(map, center_x_, center_y_ + radius_, map_meta);
    PlotPointProbability(map, center_x_, center_y_ - radius_, map_meta);
    PlotPointProbability(map, center_x_ + radius_, center_y_, map_meta);
    PlotPointProbability(map, center_x_ - radius_, center_y_, map_meta);
...
int CircularObstacle::GetMinX() { return center_x_ - radius_; }

int CircularObstacle::GetMaxX() { return center_x_ + radius_; }

int CircularObstacle::GetMinY() { return center_y_ - radius_; }

int CircularObstacle::GetMaxY() { return center_y_ + radius_; }
